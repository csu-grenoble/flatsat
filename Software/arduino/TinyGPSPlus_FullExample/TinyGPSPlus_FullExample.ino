...
/*
   ...
   4800-baud serial GPS device hooked up on pins D5 (rx) and D4 (tx).
*/

// On Thingsat @ INISAT
// RAK5146 internal GNSS module or Mikrobus GNSS Module

static const int RXPin = D5, TXPin = D4;
static const int PPSPin = A6;
static const int OnboardLED = 13;
